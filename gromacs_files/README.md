...
5. pdb2gmx outputs gro files as well that need to be combined. Merge the processed gro files together using MDAnalaysis, use [merge_gro_files.py](DNA_Mechanics/code/merge_gro_files.py).
