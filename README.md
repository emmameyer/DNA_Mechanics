...
2. Extract structural parameters from the trajectory with `do_x3dna`. The important outputted .xvg file will be "Twist_". =3. Analyze and plot using the scripts in `code` (twist_analysis, stacking_hbond, plotters as needed).
